...
public class Score1 {
	...
	public void score()
	{
		...
		ImageIcon beforeimg=new ImageIcon("image/이전화살표.png");//ImageIcon으로 이미지를 beforeimg에 저장
		
		JButton button1=new JButton(beforeimg);//beforeimg을 button1에 넣음
		...
		panel1.add(button1);//panel에 button1 추가		
	...
	public class first implements ActionListener//first 엑션이벤트 클래스
	{
		public void actionPerformed(ActionEvent e){
			...
			try{// "노을을바라보는 개구리"음악을 시작
				File file = new File("image/함정 카드.wav");
	...
	{
		public void actionPerformed(ActionEvent e){//second 엑션이벤트 클래스
			view=new View();//View객체 생성
